...
Es un sistema de registro que optimiza de manera digital los datos de un visitante,toma fotos y envias un correo electronico a la persona quien espera su visita.

Nuestro producto resuelve 4 poblemas que actualmente presenta las instalaciones del If Recoleta los cuales son los siguientes :

1) Optimiza los registros de usuario
2) Envia notificacion del viistante al administrador 
3) Registra la salida del visitante
4) Avisa al visitante devolver la credencial del lugar
